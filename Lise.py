...
sinir.append(int(input("Edebiyat dersi için ")))
sinir.append(int(input("Yabancı dil dersi için ")))
sinir.append(int(input("Fizik dersi için ")))
sinir.append(int(input("Coğrafya dersi için ")))
sinir.append(int(input("Tarih dersi için ")))
...
sinir.append(int(input("Kimya dersi için ")))
sinir.append(int(input("Felsefe dersi için ")))
...
while len(bosaltilmasi_lazim) != 0:
    ...
    if elema == "edebiyat":
        ...
        x = len(edebiyat)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin edebiyat notu ".format(edebiyat[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "fizik":
        ...
        x = len(fizik)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin fizik notu ".format(fizik[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "cografya":
        ...
        x = len(cografya)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin coğrafya notu ".format(cografya[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "tarih":
        ...
        x = len(tarih)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin tarih notu ".format(tarih[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "kimya":
        ...
        x = len(kimya)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin kimya notu ".format(kimya[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "felsefe":
        ...
        x = len(felsefe)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin felsefe notu ".format(felsefe[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "Ek_1":
        ...
        x = len(Ek_1)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin Ek-1 notu ".format(Ek_1[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "Ek_2":
        ...
        x = len(Ek_2)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin Ek-2 notu ".format(Ek_2[y]))))
            y = y+1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "Ek_3":
        ...
        x = len(Ek_3)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin Ek-3 notu ".format(Ek_3[y]))))
            y = y + 1
        puan = 100
        b = 0
        c = 0
    ...
    if elema == "Ek_4":
        ...
        x = len(Ek_4)
        while y != x:
            notlar.append(int(input("{} adlı öğrencinin Ek-4 notu ".format(Ek_4[y]))))
            y = y + 1
        puan = 100
        b = 0
        c = 0
...
if mod == 1:
    ...
    print(mat)
    print("")
    print("Edebiyat dersinden proje alanlar:")
    print(edebiyat)
    print("")
    print("Yabancı Dil dersinden proje alanlar:")
    print(yd)
    print("")
    print("Fizik dersinden proje alanlar:")
    print(fizik)
    print("")
    print("Coğrafya dersinden proje alanlar:")
    print(cografya)
    print("")
    print("Tarih dersinden proje alanlar:")
    print(tarih)
    print("")
    ...
    print(uyd)
    print("")
    print("Kimya dersinden proje alanlar:")
    print(kimya)
    print("")
    print("Felsefe dersinden proje alanlar:")
    print(felsefe)
    print("")
